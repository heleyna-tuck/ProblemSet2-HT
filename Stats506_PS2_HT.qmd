...
Above, it looks like with a higher input, the play_dice3() function runs the fastest on aerage, while the play_dice2() and play_dice4() run fairly slower on average.
